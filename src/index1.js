...
class Index extends Component {
  constructor(props) {
    ...
    if (localStorage.getItem("islogin") == "false") {
      var r = confirm("请先登陆");
      if (r == true) {
        window.location="http://www.fahzu.com"
      }
      else {
        window.location="http://www.fahzu.com"
      }
  ...
  showBubble = () => {
    ...
    setTimeout(() => {
      ...
      let searchText = "'[Your access_token]'";
      let found;
      ...
      tri.id = 'bubble2';
      bubble.innerText = "Replace the placeholder with the access_token";
