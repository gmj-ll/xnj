      ...
      <div className="bg">
        <div className='content'>
          <div className="form  sign-in">
            ...
            <div className="xiaohui">
              <div>临时实验账户:temp 密码:temp</div>
              <div>正式账户联系18158177774申请。</div>
            </div>
          </div>
        ...
        <div className="foot">
          ...
          <div>
            ...
            <a target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=33011802001970" className="myahref1">< img src={huizhang} className="myimg" /><p className="myp">浙公网安备 33011802001970号</p ></a >
          </div>
          {/* <div className="mydiv">
