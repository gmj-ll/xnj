...
Localization.localizedStringList = {
    ...
    "zh-CN": {
        _displayName: "简体中文",
        pageTitle: "Raspberry Pi Aliyun IoT Online Simulator",
        pageTitleMobile: "Raspberry Pi Simulator",
        buttonRun: "运行",
        buttonStop: "停止",
        buttonReset: "重置",
        ...
        helpTitle1: "树莓派虚拟仿真平台概述",
        helpTitle2: "创建阿里云物联网平台并新建产品和设备，获取设备证书信息和钉钉群机器人Token",
        helpTitle3: "在树莓派虚拟仿真平台上运行示例应用程序",
        helpContentAssemblyArea: "组装区",
        helpContentCodingArea: "集成控制台窗口",
        helpContentConsoleArea: "编码区域",
        helpContentAssemblyAreaDescription: "——你可以看到设备状态。",
        helpContentCodingAreaDescription: "——显示代码输出",
        helpContentConsoleAreaDescription: "——一个联机代码编辑器，可在其中使用 Raspberry Pi 进行编码。",
        helpContentInThe: "在",
        helpContentClick: "点击",
        helpContentAdd: "添加",
        helpContentAzurePortal: "阿里云",
