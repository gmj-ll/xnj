...
function connectMysql(){
  request('http://47.111.177.25/api/addcat.php?Temperature='+Temperature+'&Humidity='+Humidity, function (error, response, body) {
...
function connectdingTalk(){
  request('http://47.111.177.25/api/dingTalk.php?Temperature='+Temperature+'&Humidity='+Humidity+'&access_token='+access_token, function (error, response, body) {
